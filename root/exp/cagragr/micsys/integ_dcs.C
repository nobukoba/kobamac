...
void integ_dcs(){
  ...
  TF2 *f2_cut = new TF2("f2_cut",dcs_fuc_2_cut,-pi/8., pi/8., -pi/8., pi/8.,0);
  f2->SetNpx(400);
  f2->SetNpy(400);
  f2_cut->SetNpx(400);
  f2_cut->SetNpy(400);
...
//    f2_cut->Integral(theta_s_in_rad-0.02,theta_s_in_rad+0.02,-0.03, 0.03) / (0.04 * 0.06) << std::endl;
//  
//  std::cout << "f2->Integral/4.8 mrad: " <<
//    f2_cut->Integral(theta_s_in_rad-0.02,theta_s_in_rad+0.02,-0.05, 0.05) / (0.04 * 0.10) << std::endl;
