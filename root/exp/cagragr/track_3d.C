...
void track_3d(){
  ...
  view->SetRange(-1000.,-300.,-1000.,1000.,300.,1000.);
  ...
  for (Int_t i = 0; i < 1000; i++) {
    ...
    l->SetPoint(0, x+th*d2r*(-1000.), y+ph*d2r*(-1000.), -1000.);
    l->SetPoint(1, x+th*d2r*1000.,    y+ph*d2r*1000.,    1000.);
    l->Draw();
  }
